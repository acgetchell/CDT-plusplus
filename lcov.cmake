...
ctest_start(lcov)
message("configuring...")
ctest_configure(BUILD "${CTEST_BINARY_DIRECTORY}" OPTIONS "-DCMAKE_TOOLCHAIN_FILE=$HOME/vcpkg/scripts/buildsystems/vcpkg.cmake;-DCMAKE_CXX_FLAGS=-g -O0 -fprofile-arcs -ftest-coverage;-DCMAKE_BUILD_TYPE=Debug")
...
execute_process(COMMAND lcov -r ${CTEST_BINARY_DIRECTORY}/stepcode.lcov "*/usr/include" "*/usr/include/*" "*CGAL*" "*CGAL/*" "*boost*" "*boost/*" "*tbb*" "*tbb/*" "tests/*" "*/docopt*"
