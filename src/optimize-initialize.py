...
hyper_params = {'simplices': 32000, 'foliations': 12 }
experiment.log_multiple_params(hyper_params)

command_line = "../build/initialize --s -n" + str(experiment.get_parameter("simplices")) + " -t" + str(experiment.get_parameter("foliations"))
