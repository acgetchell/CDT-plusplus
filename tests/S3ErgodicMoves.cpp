...
SCENARIO("Perform ergodic moves upon S3 Triangulations","[moves]")
{
  GIVEN("A 3D 2-sphere foliated triangulation.")
  {
    ...
    WHEN("A (2,3) move is performed.")
    {
      ...
      THEN("The move is correct and the triangulation invariants are maintained.")
      {
        ...
        std::cout << "There were " << attempted_moves[0] << " attempted (2,3) moves.\n";
      }
    }
    WHEN("A (3,2) move is performed.")
    {
      ...
      THEN("The move is correct and the triangulation invariants are maintained.")
      {
        ...
        std::cout << "There were " << attempted_moves[1] << " attempted (3,2) moves.\n";
      }
    }
    WHEN("A (2,6) move is performed.")
    {
      ...
      THEN("The move is correct and the triangulation invariants are maintained.")
      {
        ...
        std::cout << "There were " << attempted_moves[2] << " attempted (2,6) moves.\n";
      }
    }
    WHEN("A (6,2) move is performed.")
    {
      ...
      THEN("The move is correct and the triangulation invariants are maintained.")
      {
        ...
        std::cout << "There were " << attempted_moves[3] << " attempted (6,2) moves.\n";
      }
    }
  }
}
