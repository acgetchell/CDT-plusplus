...
namespace utilities
{
  ...
  [[nodiscard]] inline auto generate_filename(ManifoldType const& manifold)
  {
    return generate_filename(ManifoldType::topology, ManifoldType::dimension,
  ...
  /// @details The filename is generated by the **generate_filename()** and
  ...
  {
    std::string filename;
    filename.assign(generate_filename(t_universe));
