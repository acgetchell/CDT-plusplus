...
TEST_F(S3ErgodicMoveTest, MakeA62Move){
  ...
  EXPECT_THAT(universe_.geometry.timelike_edges.size(), Eq(timelike_edges_before - 2))
    << "Timelike edges did not decrease by 2.";

  EXPECT_THAT(universe_.geometry.spacelike_edges, Eq(spacelike_edges_before - 3))
