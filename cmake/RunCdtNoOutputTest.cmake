...
if(NOT help_output MATCHES "--no-output")
  message(FATAL_ERROR "cdt --help does not document --no-output")
endif()
...
execute_process(
  COMMAND "${CDT_EXECUTABLE}" -s -n64 -t3 -a0.6 -k1.1 -l0.1 -p1 -c1 --no-output
