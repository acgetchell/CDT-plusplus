...
IF DEFINED CACHED_TOOLCHAIN IF /I NOT "%CACHED_TOOLCHAIN%"=="%EXPECTED_TOOLCHAIN%" GOTO REFRESH_CMAKE_CACHE
IF DEFINED CACHED_INSTALLED IF /I NOT "%CACHED_INSTALLED%"=="%EXPECTED_INSTALLED%" GOTO REFRESH_CMAKE_CACHE
EXIT /B 0
