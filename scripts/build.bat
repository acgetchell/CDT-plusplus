...
cmake -G "Visual Studio 16 2019" -A x64 -D CMAKE_BUILD_TYPE=Debug -D ENABLE_CCACHE:BOOL=FALSE -D CMAKE_TOOLCHAIN_FILE=%VCPKG_PATH%/scripts/buildsystems/vcpkg.cmake ..
cmake --build .
